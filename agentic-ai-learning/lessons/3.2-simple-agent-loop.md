...
```
User: "Weather in Mumbai and Delhi? Average temp?"
                    │
                    ▼
┌─────────────────────────────────────────────────────────┐
│ ITERATION 1                                              │
│                                                          │
│  LLM thinks: "I need weather for two cities.            │
│               I'll start with Mumbai."                   │
│                                                          │
...
│ ITERATION 2                                              │
│                                                          │
│  LLM thinks: "Got Mumbai. Now I need Delhi."            │
│                                                          │
...
│ ITERATION 3                                              │
│                                                          │
│  LLM thinks: "Got both temps. Now calculate average."   │
│                                                          │
│  → tool_call: calculate("(32+38)/2")                    │
│  ← result: "35.0"                                       │
│                                                          │
│  Not done yet → LOOP AGAIN                              │
└─────────────────────────────────────────────────────────┘
...
│ ITERATION 4                                              │
│                                                          │
│  LLM thinks: "I have everything. Time to answer!"       │
│                                                          │
│  → NO tool_calls                                        │
│  → content: "Mumbai: 32°C, Delhi: 38°C. Average: 35°C" │
│                                                          │
│  ✅ FINAL ANSWER → BREAK OUT OF LOOP                    │
└─────────────────────────────────────────────────────────┘
```
