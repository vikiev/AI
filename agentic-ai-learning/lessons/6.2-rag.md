...
│                                                              │
│  Step 1: Search YOUR documents for "leave policy"            │
│  Step 2: Find relevant chunks from employee handbook         │
│  Step 3: Give those chunks to the LLM as context             │
│  Step 4: LLM answers based on YOUR data                      │
│                                                              │
│  Agent: "According to the handbook, you get 24 days..."      │
└─────────────────────────────────────────────────────────────┘
```
...
│  ┌─────────────┐                                             │
│  │ handbook.pdf│                                             │
│  │ policy.docx │──→ CHUNK ──→ EMBED ──→ STORE               │
│  │ faq.txt     │    (split)   (vector)  (vector DB)          │
│  └─────────────┘                                             │
│                                                               │
│  "You get 24 days leave..." → [0.12, -0.34, 0.56, ...]       │
│  "Sick leave requires..."   → [0.08, -0.22, 0.44, ...]       │
│                                                               │
└─────────────────────────────────────────────────────────────┘
...
│       ↓                                                       │
│  EMBED question → [0.11, -0.31, 0.52, ...]                   │
│       ↓                                                       │
│  SEARCH vector DB → Find most similar chunks                 │
│       ↓                                                       │
│  Top 3 chunks: "You get 24 days...", "Leave resets...", ...  │
│       ↓                                                       │
│  PROMPT: "Based on this context: [chunks] Answer: [question]"│
│       ↓                                                       │
│  LLM: "According to company policy, you get 24 days..."      │
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
