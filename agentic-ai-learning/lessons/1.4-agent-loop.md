...
│   │          │    │          │    │          │    │          │    │
│   │ Assemble │    │ LLM API  │    │ Execute  │    │ Process  │    │
│   │ messages │    │ call     │    │ tool OR  │    │ result,  │    │
│   │ array    │    │          │    │ return   │    │ update   │    │
│   │          │    │          │    │ answer   │    │ messages │    │
│   └──────────┘    └──────────┘    └──────────┘    └──────────┘    │
│        ▲                                                │          │
...
├─────────────────────────────────────────────────────────────────┤
│                                                                   │
│  1.1 LLM          → Pattern engine. Predicts next token.         │
│                      Stateless. Hallucinates. Needs grounding.    │
│                                                                   │
│  1.2 Agent        → LLM + Loop + Tools + Memory + Planning       │
│                      Autonomy spectrum (Level 0-5)                │
│                                                                   │
│  1.3 Four Pillars → Reasoning (LLM decisions)                    │
│                      Tools (actions in the world)                 │
│                      Memory (context management)                  │
│                      Planning (goal decomposition)                │
│                                                                   │
│  1.4 Agent Loop   → while not done:                              │
│                        think → act → observe                      │
│                      Stop conditions. Error recovery. Debugging.  │
│                                                                   │
└─────────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────────┐
│                    MODULE 2: HANDS-ON SETUP                       │
│                                                                   │
│  Next: Python environment + OpenAI API + your first LLM call     │
│  Then: Function calling + YOUR first agent loop                   │
└─────────────────────────────────────────────────────────────────┘
```
