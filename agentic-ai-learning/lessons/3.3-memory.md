...
│                                                               │
│   You ──"Hi"──▶ AI (remembers) ──"Hello!"──▶ You            │
│   You ──"Bye"──▶ AI (still remembers) ──"Goodbye!"──▶ You   │
│                                                               │
│   What ACTUALLY happens:                                      │
│                                                               │
│   You ──["Hi"]──▶ AI (fresh brain) ──"Hello!"──▶ You        │
│   You ──["Hi","Hello!","Bye"]──▶ AI (fresh brain) ──"Bye!"  │
│                                                               │
│   The AI sees the FULL HISTORY every time.                   │
│   It doesn't "remember" — YOU remind it.                     │
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
...
│  → The messages list                                         │
│  → Lasts for one conversation                                │
│  → Limited by context window (128K tokens)                   │
│                                                               │
│  💾 LONG-TERM (Persistent Memory)                            │
│  "What do I know about this user from past sessions?"        │
│  → Database / file / vector store                            │
│  → Survives across conversations                             │
│  → Requires extra code + storage                             │
│                                                               │
│  📋 EPISODIC (Task Memory)                                   │
│  "What steps have I already taken for THIS task?"            │
│  → Tool results within the agent loop                        │
│  → Lost when the task completes                              │
│  → Automatically handled by the loop                         │
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
