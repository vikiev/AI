...
├─────────────────────────────────────────────────────────────┤
│                                                              │
│   You ask: "Research quantum computing"                      │
│                                                              │
│   Agent thinks: "I should search for this topic"             │
│   Agent acts:   search_topic("quantum computing")            │
│   Agent sees:   [3 articles returned]                        │
│                                                              │
│   Agent thinks: "I should save key findings as notes"        │
│   Agent acts:   save_note("QC uses qubits...")              │
│   Agent sees:   "Note saved ✅"                              │
│                                                              │
│   Agent thinks: "I should summarize everything"              │
│   Agent acts:   summarize(all_notes)                         │
│   Agent sees:   [clean summary]                              │
│                                                              │
│   Agent responds: "Here's what I found about QC..."         │
│                                                              │
└─────────────────────────────────────────────────────────────┘
```
...
User: "Research quantum computing"
         │
         ▼
┌─ Agent Loop (SDK handles this) ─────────────────┐
│                                                   │
│  Iteration 1:                                    │
│    LLM thinks: "I should search for this"        │
│    Tool call: search_topic("quantum computing")  │
│    Result: [4 facts returned]                    │
│                                                   │
│  Iteration 2:                                    │
│    LLM thinks: "I should save key findings"      │
│    Tool call: save_note("Qubits use...")         │
│    Result: "Note saved ✅"                        │
│                                                   │
│  Iteration 3:                                    │
│    LLM thinks: "I should save more"              │
│    Tool call: save_note("Google supremacy...")   │
│    Result: "Note saved ✅"                        │
│                                                   │
│  Iteration 4:                                    │
│    LLM thinks: "I have enough, let me respond"   │
│    No tool call → final answer                   │
│                                                   │
└───────────────────────────────────────────────────┘
         │
         ▼
User sees: Clean summary with saved notes
```
